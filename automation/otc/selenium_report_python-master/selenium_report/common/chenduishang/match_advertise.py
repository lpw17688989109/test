...
from common.chenduishang.send_sms import send_sms

s = requests.session()
def match_advertise():
    u'''xiadan'''
    method="post"
    urlprice=config_read.configread("D:\\自动化\\otc\\selenium_report_python-master\\selenium_report\\config","new.ini","url","ceshiip")+"18110/order/buy/match-advertise"
    print(urlprice)
