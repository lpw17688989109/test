...
def register(phone,yqm,deviceType):
    u'''这里写了一个登录的方法,账号和密码参数化'''
    method = "post"
    url1 = config_read.configread("D:\\自动化\\otc\\selenium_report_python-master\\selenium_report\\config", "new.ini",
                                  "url", "ceshiip") + "8087/api/user/acceptor/register"
    print(url1)
    headers1 = {'Content-Type': 'application/json', 'channel': '0','deviceType': deviceType}
    body1 = {"code": yqm, "countryId": 1, "loginPassword": "d13149de00848eb013cad318d27829db64b965d7", "phone": phone}
