...
def code2(phone,type):
    ...
    # print(url1)
    headers1 = {'Content-Type': 'application/json', 'channel': '0','token':config_read.configread(
            "D:\\自动化\\otc\\selenium_report_python-master\\selenium_report\\config", "new.ini",
            "token" + str(phone),"token" + str(phone)) }


    body1 = {"countryCode": "0086", "enName": "CNY", "phone": phone, "type": type}
